...
- **Internal MCP Server:** Превращение части NestJS-серкера (или отдельный сервис) в MCP-сервер для прямого взаимодействия ИИ с БД, Jira и логами. Экономия токенов и повышение надежности действий.
